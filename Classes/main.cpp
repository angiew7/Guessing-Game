...
Angie Wang
11/7/2022
This program allows the user to add, search, and delete
3 different media types: Video games, music, and movies
 */
#include <iostream>
#include <vector>
#include <cstring>
...
int main(){
  ...
  void Add(vector<parent*>&list){
    ...
    //Video Games
    if(strcmp(type, "Video-games") == 0 || strcmp(type, "Video games") ==0){
      vg* v = new vg();
      p = v;
      cout << "Enter Title: " << endl;
      ((parent*)p)->setTitle();
